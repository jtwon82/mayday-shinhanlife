...
namespace OrangeSummer.Access
{
    ...
    public class Banner
    {
        ...
        public List<Model.Banner> ListBackground(int page, int size, string type)
        {
            List<Model.Banner> lists = null;
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@PAGE", page));
            parameters.Add(new SqlParameter("@SIZE", size));
            parameters.Add(new SqlParameter("@TYPE", type));
            using (DataTable dt = DBHelper.ExecuteDataTable(_connection, "ADM_BANNER_BACKGROUND_LIST", parameters))
            {
                if (dt.Rows.Count > 0)
                {
                    lists = new List<Model.Banner>();
        ...
        public Model.Banner DetailBackground(string id, string type)
        {
            Model.Banner banner = null;
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@ID", id));
            parameters.Add(new SqlParameter("@TYPE", type));
            using (DataTable dt = DBHelper.ExecuteDataTable(_connection, "ADM_BANNER_BACKGROUND_DETAIL", parameters))
            {
                if (dt.Rows.Count == 1)
                {
                    DataRow dr = dt.Rows[0];
        ...
        public bool RegistBackground(Model.Banner banner)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@FK_ADMIN", banner.FkAdmin));
            parameters.Add(new SqlParameter("@TYPE", banner.Type));
            ...
            return DBHelper.ExecuteNonQuery(_connection, "ADM_BANNER_BACKGROUND_REGIST", parameters);
        }
        ...
        public bool ModifyBackground(Model.Banner banner)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@ID", banner.Id));
            parameters.Add(new SqlParameter("@TYPE", banner.Type));
            ...
            return DBHelper.ExecuteNonQuery(_connection, "ADM_BANNER_BACKGROUND_MODIFY", parameters);
        }
        ...
        public bool DeleteBackground(string id, string type)
        {
            List<SqlParameter> parameters = new List<SqlParameter>();
            parameters.Add(new SqlParameter("@ID", id));
            parameters.Add(new SqlParameter("@TYPE", type));

            return DBHelper.ExecuteNonQuery(_connection, "ADM_BANNER_BACKGROUND_DELETE", parameters);
        }
        #endregion
