...
namespace MLib.Util
{
    public static class Check
    {
        ...
        /// <returns>bool</returns>
        public static string getValue(DataRow dr, string fieldName, string formatStr)
        {
            try
            {
                return Check.IsNone(dr[fieldName].ToString()) ? "" : Convert.ToDecimal(dr[fieldName].ToString()).ToString(formatStr);
            }
            catch (Exception ex)
            {
                return ex.ToString();
        ...
        public static string getValueFormat(DataRow dr, string fieldName, string format)
        {
            try
            {
                return String.Format(format, Convert.ToDouble(dr[fieldName].ToString()));
            }
            catch (Exception ex)
            {
                return ex.ToString();
