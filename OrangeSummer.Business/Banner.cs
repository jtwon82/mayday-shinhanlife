...
namespace OrangeSummer.Business
{
    ...
    public class Banner : IDisposable
    {
        ...
        {
            return _banner.ListBackground(page, size, type);
        }
        ...
        {
            return _banner.DetailBackground(id, type);
        }
        ...
        {
            return _banner.RegistBackground(banner);
        }
        ...
        {
            return _banner.ModifyBackground(banner);
        }
        ...
        {
            return _banner.DeleteBackground(id, type);
        }
        #endregion
