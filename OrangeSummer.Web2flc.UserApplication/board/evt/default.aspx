<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Web2flc.UserApplication.board.evt._default" %>
			...
			<div class="eventPage" id="scratcEvent">
				...
				<div class="info_">
					<ul>
						...
						<li><span>이벤트경품</span>썸머 기간 커피쿠폰 총 780명<br>랜덤 추첨 증정</li>
					</ul>
