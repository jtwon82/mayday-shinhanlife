<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Web2flc.UserApplication.ranking.sl._default" %>
    ...
    <body>
		...
		<div class="subContainer">
			...
			<ul class="bmTabs measure ranking">
							...
							<li>
								<a href="/ranking/sl" class="current">E SL 부문</a>
							</li>
							<li>
