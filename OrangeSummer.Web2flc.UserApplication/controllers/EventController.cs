...
namespace OrangeSummer.Web2flc.UserApplication.controllers
{
    public class EventController : ApiController
    {
        ...
        public HttpResponseMessage Like(LikeRequest request)
        {
            ...
            try
            {
                ...
                using (Business.EventReply biz = new Business.EventReply(Common.User.AppSetting.Connection))
                {
                    Model.EventReplyLike like = biz.UserLike(request.Id, Common.User.Identify.Id);
        ...
        public HttpResponseMessage Regist(RegistRequest request)
        {
            ...
            try
            {
                ...
                using (Business.EventReply biz = new Business.EventReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserRegist(new Model.EventReply()
                    {
        ...
        public HttpResponseMessage Modify(ModifyRequest request)
        {
            ...
            try
            {
                ...
                using (Business.EventReply biz = new Business.EventReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserModify(new Model.EventReply()
                    {
                        Id = request.Id,
                        FkMember = Common.User.Identify.Id,
                        Contents = request.Contents.Replace("\n", Environment.NewLine)
        ...
        public HttpResponseMessage Answer(AnswerRequest request)
        {
            ...
            try
            {
                ...
                using (Business.EventReply biz = new Business.EventReply(Common.User.AppSetting.Connection))
                {
                    bool result = biz.UserAnswer(new Model.EventReply()
                    {
                        Id = request.Id,
                        FkMember = Common.User.Identify.Id,
                        Contents = request.Contents.Replace("\n", Environment.NewLine)
