<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Web2.UserApplication.ranking.gsl._default" %>
				...
				<div class="subContainer">
					...
					<div>
						...
						<ul class="bmTabs measure ranking two">
							<li>
								<a href="/ranking/gsl" class="current">G SL 부문</a>
							</li>
							<li>
