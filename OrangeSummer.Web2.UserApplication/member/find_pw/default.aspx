			...
			<div class="signup_wrap">
				...
				<div class="input_wrap">
					<div class="form_group">
                        ...
                        <asp:TextBox ID="user_name" runat="server" ClientIDMode="Static" MaxLength="10" placeholder="실명으로 등록해 주세요." CssClass="form_control"></asp:TextBox>
					...
					<div class="form_group">
						...
						<asp:TextBox ID="user_fccode" type="number" runat="server" ClientIDMode="Static" MaxLength="8" placeholder="숫자 8자리 필수" pattern="\d*" CssClass="form_control"></asp:TextBox><!--
        ...
        common: function () {
            var literal = {
                ...
                code: {
                    ...
                    digit: { message: "FC 코드는 숫자 8자리로 입력해주세요." }
                }
            };
