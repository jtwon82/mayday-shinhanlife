<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Weblfc.MasterApplication.myreward.reward._default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-right">
        <a href="javascript:;" class="btn btn-success" data-toggle="modal" data-target="#modal-excel">
            <i class="material-icons">add</i> Excel Upload(업로드)
        </a>
    </div>
