<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Weblfc.MasterApplication.board.word._default" %>
        ...
        <asp:Repeater ID="rptRanking" runat="server">
            <ItemTemplate>
                <li class="list-group-item text-center" style="width:33.3%;">
                    ...
                    <%# Eval("Vote") %>번 <%# OrangeSummer.Common.Code.WordEventName(Eval("Vote").ToString()) %>
                </li>
            </ItemTemplate>
        </asp:Repeater>
    </ul>
