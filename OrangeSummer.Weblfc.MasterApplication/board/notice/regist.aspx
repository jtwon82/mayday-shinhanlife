<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" ValidateRequest="false" CodeBehind="regist.aspx.cs" Inherits="OrangeSummer.Weblfc.MasterApplication.board.notice.regist" %>
                ...
                <tr>
                    ...
                    <td colspan="3" class="text-left">
                        <asp:RadioButtonList ID="useyn" runat="server" ClientIDMode="Static" RepeatDirection="Horizontal" RepeatLayout="Flow">
                            ...
                            <asp:ListItem Text="미노출" Value="N" Selected="True"></asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="text-left">
                        ...
                        <small class="text-muted">* 10M 용량 미만 업로드만 가능합니다.</small>
                        <p class="m-0">
                            <asp:LinkButton ID="btnDownload" ClientIDMode="Static" runat="server" OnClick="btnDownload_Click" Visible="false" CssClass="btn btn-primary btn-ssm">
                                <i class="material-icons" style="font-size:small;">vertical_align_bottom</i> 다운로드
                            </asp:LinkButton>
                            <asp:LinkButton ID="btnDelFile" ClientIDMode="Static" runat="server" OnClientClick="if(!data.file()) { return false; }" Visible="false" CssClass="btn btn-ssm btn-secondary">
                                <i class="material-icons" style="font-size:small;">close</i> 삭제
                            </asp:LinkButton>
                        </p>
                        <asp:HiddenField ID="attfiled" runat="server" ClientIDMode="Static" />
                        <asp:HiddenField ID="attfilenamed" runat="server" ClientIDMode="Static" />
                    </td>
                </tr>
                <%
...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var data = {
            ...
            file: function () {
                if (confirm("삭제하시겠습니까?")) {
                    $("#<%= this.btnDownload.ClientID %>, #<%= this.btnDelFile.ClientID %>").hide();
                    $("#<%= this.attfiled.ClientID %>").val("");
                    return false;
                } else {
                    return false;
                }
