<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="regist.aspx.cs" Inherits="OrangeSummer.Weblfc.MasterApplication.main.banner.regist" %>
...
<%--                        <small class="text-muted">* 메인배너 Size : 626*312 px입니다.</small><br />
                        <small class="text-muted">* 이벤트페이지배너 Size : 가로640*세로347 px입니다.</small>--%>
                        <small class="text-muted">* 메인배너 / 이벤트페이지배너 Size : 626*312 px입니다.</small>
