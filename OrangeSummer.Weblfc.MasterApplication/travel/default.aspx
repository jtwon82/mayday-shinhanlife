<%@ Page Title="" Language="C#" MasterPageFile="~/common/master/page.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="OrangeSummer.Weblfc.MasterApplication.travel._default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p class="mb-1">* 총 <span class="text-danger font-weight-bold"><%= _total %></span>개의 여행지가 있습니다.</p>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>구분 #<%# Eval("Section").ToString() %></td>
    ...
    <div class="text-right">
        <a href="regist.aspx" class="btn btn-success">
            <i class="material-icons">add</i> 여행지 등록
        </a>
    </div>
</asp:Content>
