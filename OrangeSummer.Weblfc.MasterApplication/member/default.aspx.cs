...
namespace OrangeSummer.Weblfc.MasterApplication.member
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected string Parameters(string add)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            sb.Append("&page=" + Check.IsNone(Request["page"], "1"));
            sb.Append("&branch=" + Check.IsNone(Request["branch"], ""));
                    ...
                    if (list != null)
                    {
                        ...
                        using (XLWorkbook book = new XLWorkbook())
                        {
                            ...
                            foreach (Model.Member item in list)
                            {
                                ...
                                sheet.Cell("D" + index).Style.NumberFormat.Format = new string('0', item.Code.Length);
